...
data_model_train = WZModel(what='VV_eflow', scalar_features = scalar_features, operator='cW', nsplit=500, train=True , linear_term_range=[-1000,1000])
data_model_test  = WZModel(what='VV_eflow', scalar_features = scalar_features, operator='cW', nsplit=500, train=False, linear_term_range=[-1000,1000])
