...
data_generator =  DataGenerator(
    input_files = ["/scratch-cbe/users/robert.schoefbeck/HadronicSMEFT/postprocessed/gen/v1/WhadZlepJJ/WhadZlepJJ_*.root"],
        ...
        branches = [
                    ...
                    "parton_hadV_pt", "parton_hadV_eta", "parton_hadV_phi", "parton_hadV_mass", "parton_hadV_pdgId", "parton_hadV_theta", "parton_hadV_Theta", "parton_hadV_phi", 
                    ...
                    "parton_hadV_theta", "parton_hadV_Theta", "parton_hadV_phi", 
...
plot_options =  {
    ...
    "parton_hadV_eta":               {'binning':[50,-5,5], 'tex':'#eta(had V)'},
    "parton_hadV_mass":              {'binning':[50,50,150], 'tex':'M(had V)'},

    "parton_hadV_theta":             {'binning':[50,-math.pi,math.pi], 'tex':'#theta'},
    "parton_hadV_Theta":             {'binning':[50,-math.pi,math.pi], 'tex':'#Theta'},
    "parton_hadV_phi":               {'binning':[50,-math.pi,math.pi], 'tex':'#phi'},
    ...
    "delphesJet_dR_matched_hadV_parton": {'binning':[50,0,1], 'tex':'#Delta R(jet, had V)'},
    "delphesJet_dR_lepV_parton":         {'binning':[50,0,1], 'tex':'#Delta R(jet, lep V)'},
    "delphesJet_dR_hadV_q1":             {'binning':[50,0,1], 'tex':'#Delta R(jet, q_{1})'},
    "delphesJet_dR_hadV_q2":             {'binning':[50,0,1], 'tex':'#Delta R(jet, q_{2})'},
    "delphesJet_dR_hadV_maxq1q2":        {'binning':[50,0,1], 'tex':'max #Delta R(jet, q_{1,2})'},

    "delphesJet_pt"                 :{'binning':[50,500,2000], 'tex':'p_{T}(jet)'},
    "delphesJet_eta"                :{'binning':[50,-5,5], 'tex':'#eta(jet)'},
    "delphesJet_mass"               :{'binning':[50,150,200], 'tex':'M(jet) unpruned'},
    "delphesJet_nConstituents"      :{'binning':[50,30,230], 'tex':'n-constituents'},
    "delphesJet_SDmass"             :{'binning':[50,150,200], 'tex':'M_{SD}(jet)'},
    ...
    "delphesJet_SDsubjet0_mass"     :{'binning':[50,0,200], 'tex':'M_{SD}(jet_{0})'},
    ...
    "delphesJet_SDsubjet1_mass"     :{'binning':[50,0,200], 'tex':'M_{SD}(jet_{1})'},
    "delphesJet_tau1"               :{'binning':[50,0,1], 'tex':'#tau_{1}'},
    "delphesJet_tau2"               :{'binning':[50,0,.5],'tex':'#tau_{2}'},
    "delphesJet_tau3"               :{'binning':[50,0,.3],'tex':'#tau_{3}'},
    "delphesJet_tau4"               :{'binning':[50,0,.3],'tex':'#tau_{4}'},
...
#https://github.com/cms-sw/cmssw/blob/6d2f66057131baacc2fcbdd203588c41c885b42c/RecoJets/JetProducers/python/ECF_cff.py
    ...
    "delphesJet_ecf2"               :{'binning':[50,0,400000], 'tex':"ecf2"},
    "delphesJet_ecf3"               :{'binning':[50,0,4000000], 'tex':"ecf3"},
    ...
    "delphesJet_ecfN1"              :{'binning':[50,0,0.5], 'tex':"ecfN1"},
    "delphesJet_ecfN2"              :{'binning':[50,0,0.5], 'tex':"ecfN2"},
    "delphesJet_ecfN3"              :{'binning':[50,0,5], 'tex':"ecfN3"},
    "delphesJet_ecfN1beta2"         :{'binning':[50,0,0.5], 'tex':"ecfN1beta2"},
    ...
    "delphesJet_ecfU1beta2"         :{'binning':[50,0,0.5], 'tex':"ecfU1beta2"},
    "delphesJet_ecfU2beta2"         :{'binning':[50,0,0.04], 'tex':"ecfU2beta2"},
    "delphesJet_ecfU3beta2"         :{'binning':[50,0,0.004], 'tex':"ecfU3beta2"},
}
